...
class Exchange(object):
    ...
    def get_action(self, conversation_ref,conversation_state):
        ...
        conversation_duration_hours = abs(datetime.now(timezone.utc)-conversation_ref.get().to_dict().get('lastactivedate')).seconds//3600
        print(conversation_duration_hours)
        if conversation_duration_days >24:
