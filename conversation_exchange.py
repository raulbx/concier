...
class Exchange(object):
    ...
    def connect_expert_to_user(self,payload,conversation_ref):
        ...
        helpeePayload= {}
        helpeeResponse = '{} made a similar purchase recently. Below is some information about {}\'s purchase.\n\nProduct bought: {}\nProduct looked at:{}\nPrice range:{}\nDifference in product:{}\nWhy member bought {}:{}\n\nWe will now connect you to {}. Please say hi!\nCommunity member will have 12 hours to interact with you before you are released back to the community. At any time, if you want to end the conversation, type #end and enter.'.format(helper_Name,helper_Name,product_bought,products_in_the_market,product_price_ranges,product_differences,product_bought,why_bought_product,helper_Name)
